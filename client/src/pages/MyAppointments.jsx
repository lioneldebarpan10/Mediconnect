      ...
      <div>
        {doctors.slice(0,3).map((item , index) => (
            <div key={index} className='grid grid-cols-1 sm:grid-cols-[auto_1fr_auto] items-start sm:items-center gap-4 sm:gap-6 py-4 border-b'>
              <div>
                <img src={item.image} alt="display-appointment-image" className='w-full sm:w-32 h-auto sm:h-32 bg-indigo-50 object-cover rounded-md'/>
              </div>
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-xs mt-1'><span className='text-xs font-medium text-neutral-700'>Date & Time:</span> 28th Feb, 2026 | 9:30 AM</p>
              </div>
